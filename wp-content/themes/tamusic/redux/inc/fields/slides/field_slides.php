        ...
        public function render () {
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $slides as $slide ) {
					...
					$placeholder = ( isset ( $this->field[ 'placeholder' ][ 'btn_text' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'btn_text' ] ) : __ ( 'Text for Button', 'redux-framework' );
                    if ( isset ( $this->field[ 'show' ][ 'btn_text' ] ) ) {
                        $btn_a_text_type = "text";
                    } else {
                        $btn_a_text_type = "hidden";
                    }
					echo '<li><input type="' . $btn_a_text_type . '" id="' . $this->field[ 'id' ] . '-btn_text_' . $x . '" name="' . $this->field[ 'name' ] . '[' . $x . '][btn_text]' . $this->field['name_suffix'] .'" value="' . esc_attr ( $slide[ 'btn_text' ] ) . '" class="full-text" placeholder="' . $placeholder . '" /></li>';
            ...
            if ( $x == 0 ) {
				...
				echo '<li><input type="' . $btn_a_text_type . '" id="' . $this->field[ 'id' ] . '-btn_text_' . $x . '" name="' . $this->field[ 'name' ] . '[' . $x . '][btn_text]' . $this->field['name_suffix'] .'" value="" class="full-text" placeholder="' . $placeholder . '" /></li>';
